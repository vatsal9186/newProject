<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vegetable2.aspx.cs" Inherits="newProject.vegetable2" %>
    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/cabbage.jpg" runat="server" /></a>
            </div>
            
            <%--<h3>Cabbage</h3>--%>
			<asp:Label ID="Label1" runat="server" Text=Cabbage></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 85₹ </p>--%>
			 <asp:Label ID="Label10" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center berry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/peas.jpg" runat="server" /></a>
            </div>
            <%--<h3>Peas</h3>--%>
			<asp:Label ID="Label2" runat="server" Text=Peas></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 70₹ </p>--%>
			 <asp:Label ID="Label12" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center lemon">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/ladyfinger.jpg" runat="server" /></a>
            </div>
            <%--<h3>LadyFinger</h3>--%>
			<asp:Label ID="Label3" runat="server" Text=LadyFinger></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 35₹ </p>--%>
			 <asp:Label ID="Label14" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/beans.jpg" runat="server" /></a>
            </div>
            <%--<h3>Beans</h3>--%>
			<asp:Label ID="Label4" runat="server" Text=Beans></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 50₹ </p>--%>
			 <asp:Label ID="Label16" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/springonion.jpg" runat="server" /></a>
            </div>
            <%--<h3>SpringOnion</h3>--%>
			<asp:Label ID="Label5" runat="server" Text=SpringOnion></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 45₹ </p>--%>
			 <asp:Label ID="Label18" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/capsicum.jpg" runat="server" /></a>
            </div>
            <%--<h3>Capsicum</h3>--%>
			<asp:Label ID="Label6" runat="server" Text=Capsicum></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 80₹ </p>--%>
			 <asp:Label ID="Label20" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center strawberry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/mushrooms.jpg" runat="server" /></a>
            </div>
            <%--<h3>Mushrooms</h3>--%>
			<asp:Label ID="Label7" runat="server" Text=Mushrooms></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 100₹ </p>--%>
			 <asp:Label ID="Label22" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center berry">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/spinach.jpg" runat="server" /></a>
            </div>
            <%--<h3>Spinach</h3>--%>
			<asp:Label ID="Label8" runat="server" Text=Spinach></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 70₹ </p>--%>
			 <asp:Label ID="Label24" runat="server"><span>Per Kg</span></asp:Label><br />
    ...
    <div class="col-lg-4 col-md-6 text-center lemon">
        <div class="single-product-item">
            <div class="product-image">
				...
				<a href="#"><asp:Image ImageUrl="assets/img/products/corn.jpg" runat="server" /></a>
            </div>
            <%--<h3>Corn</h3>--%>
			<asp:Label ID="Label9" runat="server" Text=Corn></asp:Label><br />
            <%--<p class="product-price"><span>Per Kg</span> 35₹ </p>--%>
			 <asp:Label ID="Label26" runat="server"><span>Per Kg</span></asp:Label><br />
			...
			<div class="col-lg-12 text-center">
				<div class="pagination-wrap">
					<ul>
						...
						<li><a class="" href="vegetable.aspx">1</a></li>
						<li><a class="active" href="vegetable2.aspx">2</a></li>
